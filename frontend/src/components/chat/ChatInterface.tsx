...
const NAUGHTY_PATTERNS = [
  /\b(adult|18\+|nsfw|explicit|naughty|dirty|spicy|erotic|sexual|sensual|intimate)\b/i,
  ...
  /\b(master|mistress|slave|submissive|sub|dom|dominant|domme|bdsm|kink|kinky|fetish|spank|choke|collar|leash|roleplay|role play)\b/i,
        ...
        <section className="relative flex-none max-h-[42vh] lg:max-h-none lg:flex-1 overflow-y-auto overflow-x-hidden bg-[repeating-linear-gradient(135deg,#fbfbfb_0,#fbfbfb_12px,#f7f7f7_12px,#f7f7f7_24px)]">
          <div className="flex flex-col px-4 py-4 sm:px-6 sm:py-6">
            ...
            <div className="shrink-0 mx-auto w-full max-w-3xl">
              <div className="rounded-2xl border border-stone-200 bg-white/95 shadow-soft p-2.5 sm:p-3">
                <div className="grid grid-cols-5 gap-1.5 sm:gap-2">
                  {GIFT_OPTIONS.map(({ id, label, price, Icon }) => (
                    <button
                      ...
                      className={`h-14 sm:h-16 rounded-xl border flex flex-col items-center justify-center gap-1 transition-colors ${
              ...
              <div className="mx-auto mt-3 flex w-fit items-center gap-2 rounded-full bg-white/95 border border-stone-200 shadow-soft px-4 py-3">
                <button
                  type="button"
